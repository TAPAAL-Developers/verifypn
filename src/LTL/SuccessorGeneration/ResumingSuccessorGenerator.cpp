...
ResumingSuccessorGenerator::ResumingSuccessorGenerator(
...
void ResumingSuccessorGenerator::prepare(const Structures::State &state,
                                         const successor_info_t &sucinfo) {
...
ResumingSuccessorGenerator::ResumingSuccessorGenerator(const PetriNet &net,
                                                       const std::shared_ptr<StubbornSet> &)
    : ResumingSuccessorGenerator(net) {}
