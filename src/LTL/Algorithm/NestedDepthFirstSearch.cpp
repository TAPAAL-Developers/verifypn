...
template <typename S> void NestedDepthFirstSearch<S>::print_stats(std::ostream &os) {
    std::cout << "STATS:\n"
...
template class NestedDepthFirstSearch<LTL::ResumingSuccessorGenerator>;

template class NestedDepthFirstSearch<LTL::SpoolingSuccessorGenerator>;
} // namespace LTL
