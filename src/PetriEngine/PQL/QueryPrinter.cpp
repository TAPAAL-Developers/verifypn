...
namespace PetriEngine {
    namespace PQL {
        ...
        void QueryPrefixPrinter::_accept(const NotCondition *element) {
            os << "(not ";
            Visitor::visit(this, (*element)[0]);
            os << ")";
        }
        ...
        void QueryPrefixPrinter::_accept(const LogicalCondition *element, const std::string &op) {
            os << "(" << op << " ";
            Visitor::visit(this, (*element)[0]);
            for (size_t i = 1; i < element->operands(); ++i) {
                os << " ";
        ...
        void QueryPrefixPrinter::_accept(const CompareCondition *element, const std::string &op) {
            os << "(";
            Visitor::visit(this, element->getExpr1());
            os << " " << op << " ";
            Visitor::visit(this, element->getExpr2());
        ...
        void QueryPrefixPrinter::_accept(const AndCondition *element) {
            _accept(element, "and");
        }

        void QueryPrefixPrinter::_accept(const OrCondition *element) {
            _accept(element, "or");
        }

        void QueryPrefixPrinter::_accept(const LessThanCondition *element) {
            _accept(element, "<");
        }

        void QueryPrefixPrinter::_accept(const LessThanOrEqualCondition *element) {
            _accept(element, "<=");
        }

        void QueryPrefixPrinter::_accept(const EqualCondition *element) {
            _accept(element, "==");
        }

        void QueryPrefixPrinter::_accept(const NotEqualCondition *element) {
            _accept(element, "!=");
        }

        void QueryPrefixPrinter::_accept(const DeadlockCondition *element) {
            os << "deadlock";
        }

        void QueryPrefixPrinter::_accept(const CompareConjunction *element) {
            os << "(";
            if (element->isNegated()) os << "not (";
            os << "and ";
            bool first = true;
        ...
        void QueryPrefixPrinter::_accept(const UnfoldedUpperBoundsCondition *element) {
            os << "bounds (";
            auto places = element->places();
            for (size_t i = 0; i < places.size(); ++i) {
                if (i != 0) os << ", ";
        ...
        void QueryPrefixPrinter::_accept(const ControlCondition *condition) {
            os << "control: ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const EFCondition *condition) {
            os << "EF ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const EGCondition *condition) {
            os << "EG ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const AGCondition *condition) {
            os << "AG ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const AFCondition *condition) {
            os << "AF ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const AllPaths* condition)
        {
            os << "all-paths " << condition->name() << ".";
            Visitor::visit(this, condition->child());
        }

        void QueryPrefixPrinter::_accept(const ExistPath* condition)
        {
            os << "exist-path " << condition->name() << ".";
            Visitor::visit(this, condition->child());
        }

        void QueryPrefixPrinter::_accept(const PathSelectCondition* condition)
        {
            os << condition->name() << ".";
            Visitor::visit(this, condition->child());
        }

        void QueryPrefixPrinter::_accept(const EXCondition *condition) {
            os << "EX ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const AXCondition *condition) {
            os << "AX ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const EUCondition *condition) {
            os << "E ";
            _accept((UntilCondition*) condition);
        }

        void QueryPrefixPrinter::_accept(const AUCondition *condition) {
            os << "A ";
            _accept((UntilCondition*) condition);
        }

        void QueryPrefixPrinter::_accept(const ACondition *condition) {
            os << "A ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const ECondition *condition) {
            os << "E ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const GCondition *condition) {
            os << "G ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const FCondition *condition) {
            os << "F ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const XCondition *condition) {
            os << "X ";
            Visitor::visit(this, (*condition)[0]);
        }

        void QueryPrefixPrinter::_accept(const UntilCondition *condition) {
            os << "(";
            Visitor::visit(this, condition->getCond1());
            os << " U ";
            Visitor::visit(this, condition->getCond2());
        ...
        void QueryPrefixPrinter::_accept(const UnfoldedFireableCondition *element) {
            os << "is-fireable(" << *element->getName() << ")";
        }

        void QueryPrefixPrinter::_accept(const FireableCondition *element) {
            if(element->getCompiled())
                Visitor::visit(this, element->getCompiled());
            else
                os << "is-fireable(" << *element->getName() << ")";
        ...
        void QueryPrefixPrinter::_accept(const UpperBoundsCondition *element) {
            os << "bounds (";
            auto places = element->getPlaces();
            for(size_t i = 0; i < places.size(); ++i)
            {
        ...
        void QueryPrefixPrinter::_accept(const LivenessCondition *element) {
            const Condition_ptr& cond = element->getCompiled();
            if (cond) {
                Visitor::visit(this, cond);
            }
        ...
        void QueryPrefixPrinter::_accept(const KSafeCondition *element) {
            if (element->getCompiled()) {
                Visitor::visit(this, element->getCompiled());
            }
            else {
        ...
        void QueryPrefixPrinter::_accept(const QuasiLivenessCondition *element) {
            const Condition_ptr& cond = element->getCompiled();
            if (cond) {
                Visitor::visit(this, cond);
            }
        ...
        void QueryPrefixPrinter::_accept(const StableMarkingCondition *element) {
            const Condition_ptr& cond = element->getCompiled();
            if (cond) {
                Visitor::visit(this, cond);
            }
        ...
        void QueryPrefixPrinter::_accept(const BooleanCondition *element) {
            os << (element->value ? "true" : "false");
        }

        void QueryPrefixPrinter::_accept(const UnfoldedIdentifierExpr *element) {
            os << *element->name();
        }

        void QueryPrefixPrinter::_accept(const LiteralExpr *element) {
            os << element->value();
        }

        void QueryPrefixPrinter::_accept(const CommutativeExpr *element, const std::string &op) {
            os << "(" << element->constant();
            for (const auto &id: element->places()) {
                os << " " << op << " " << *id.second;
            }
        ...
        void QueryPrefixPrinter::_accept(const NaryExpr *element, const std::string &op) {
            os << "(";
            Visitor::visit(this, (*element)[0]);
            for(size_t i = 1; i < element->operands(); ++i)
            {
        ...
        void QueryPrefixPrinter::_accept(const PlusExpr *element) {
            _accept((const CommutativeExpr *)element, "+");
        }

        void QueryPrefixPrinter::_accept(const MultiplyExpr *element) {
            _accept((const CommutativeExpr*)element, "*");
        }

        void QueryPrefixPrinter::_accept(const MinusExpr *element) {
            os << "-";
            Visitor::visit(this, (*element)[0]);
        }

        void QueryPrefixPrinter::_accept(const SubtractExpr *element) {
            _accept((const NaryExpr *)element, "-");
        }

        void QueryPrefixPrinter::_accept(const IdentifierExpr *element) {
            if(element->compiled())
                Visitor::visit(this, element->compiled());
            else
                os << *element->name();
        ...
        void QueryPrefixPrinter::_accept(const PathSelectExpr *element) {
            os << element->name() << ".";
            Visitor::visit(this, element->child());
        }
    }
