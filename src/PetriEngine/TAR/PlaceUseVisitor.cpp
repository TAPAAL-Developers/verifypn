...
void PlaceUseVisitor::_accept(const NotCondition *element) { (*element)[0]->visit(*this); }
...
void PlaceUseVisitor::_accept(const PlusExpr *element) { visit_commutative_expr(element); }
...
void PlaceUseVisitor::_accept(const MultiplyExpr *element) { visit_commutative_expr(element); }

void PlaceUseVisitor::_accept(const MinusExpr *element) { (*element)[0]->visit(*this); }
