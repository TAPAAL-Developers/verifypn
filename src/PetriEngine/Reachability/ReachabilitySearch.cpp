...
#define TEMPPAR(X, Y)  if(keep_trace) return try_reach<X, Structures::TracableStateSet, Y>TRYREACHPAR ; \
                       else return try_reach<X, Structures::StateSet, Y> TRYREACHPAR;
