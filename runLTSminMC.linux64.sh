...
lib/LTSmin/bin/pins2lts-mc --state=table --invariant="! goal" --trace=solution.gcf --when autogenerated/sharedfile.so 

#lib/LTSmin/bin/pins2lts-mc --procs=2 --invariant="! goal" --trace=solution.gcf --when autogenerated/sharedfile.so 
