...
#time ./verifypn-linux64 -o mc -r 2 -b ../models/DatabaseWithMutex-PT-02/model.pnml ../models/DatabaseWithMutex-PT-02/ReachabilityCardinality.xml #> logFiles/CircularTrains24Correctness_Multi_d.
