...
class BaseVisitor : public Visitor {
  protected:
    void _accept(const NotCondition *element) override { (*element)[0]->visit(*this); }
    ...
    void _accept(const EFCondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const EGCondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const AGCondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const AFCondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const EXCondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const AXCondition *condition) override { (*condition)[0]->visit(*this); }
    ...
    void _accept(const ACondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const ECondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const GCondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const FCondition *condition) override { (*condition)[0]->visit(*this); }

    void _accept(const XCondition *condition) override { (*condition)[0]->visit(*this); }
    ...
    void _accept(const MinusExpr *element) override { (*element)[0]->visit(*this); }
