...
#ifndef VERIFYPN_ENFV2_H
#define VERIFYPN_ENFV2_H
...
namespace PetriEngine { namespace PQL {
        ...
        Condition_ptr ENFV2(Condition_ptr cond, negstat_t& stats, const EvaluationContext& context, bool nested, bool negated, bool initrw);

        Condition_ptr ENFV2(Condition_ptr cond);

        class ENFV2Visitor : public MutatingVisitor {
        public:
            ENFV2Visitor(negstat_t& stats, const EvaluationContext& context, bool nested, bool negated, bool initrw)
