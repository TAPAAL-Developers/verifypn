...
private:
    ...
    PetriEngine::Colored::GuardExpression_ptr parse_guard_expression(rapidxml::xml_node<>* element, bool notFlag);
    ...
    PetriEngine::Colored::ArcExpression_ptr parse_number_of_expression(rapidxml::xml_node<>* element);
    void collect_colors_in_tuple(rapidxml::xml_node<>* element,std::vector<std::vector<PetriEngine::Colored::ColorExpression_ptr>>& collectedColors);
    PetriEngine::Colored::ArcExpression_ptr construct_add_expression_from_tuple_expression(rapidxml::xml_node<>* element,std::vector<std::vector<PetriEngine::Colored::ColorExpression_ptr>> collectedColors, uint32_t numberof);
    ...
    const PetriEngine::Colored::Color* find_color_for_int_range(const char* value, uint32_t start, uint32_t end) const;
    std::vector<PetriEngine::Colored::ColorExpression_ptr> find_partition_colors(rapidxml::xml_node<>* element) const;
    std::vector<std::vector<PetriEngine::Colored::ColorExpression_ptr>> cartesian_product(std::vector<PetriEngine::Colored::ColorExpression_ptr> rightVector, std::vector<PetriEngine::Colored::ColorExpression_ptr> leftVector);
    std::vector<std::vector<PetriEngine::Colored::ColorExpression_ptr>> cartesian_product(std::vector<std::vector<PetriEngine::Colored::ColorExpression_ptr>> rightVector, std::vector<PetriEngine::Colored::ColorExpression_ptr> leftVector);
