...
class StateSet : std::unordered_set<State*, State::hash, State::equal_to>{
public:
	StateSet(const PetriNet& net, int kbound = 0)
        : std::unordered_set<State*, State::hash, State::equal_to>
...
private:
    typedef std::unordered_set<State*, State::hash, State::equal_to>::const_iterator const_iter;
    typedef std::unordered_set<State*, State::hash, State::equal_to>::iterator iter;
	BigInt _discovered;
	int _kbound;
	int _maxTokens;
