...
ALL_KEYS = [
	MODEL_NAME, NO_TRANSITIONS, NO_PLACES, MODEL_PARSING_TIME, QUERY_PARSING_TIME, FORMULA,
	QUERY_RESULT, QUERY_EVALUATION_TIME, TOTAL_EVALUATION_TIME, NO_CONFIGURATIONS, NO_MARKINGS
]
